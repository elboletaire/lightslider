        ...
        plugin = {
            ...
            controls: function () {
                if (settings.controls) {
                    $el.closest('.ls-slide-outer').append('<div class="ls-action"><a class="ls-prev">' + settings.prevHtml + '</a><a class="ls-next">' + settings.nextHtml + '</a></div>');
                    ...
                    $el.closest('.ls-slide-outer').find('.ls-action a').on('click', function (e) {
                        e.preventDefault();
